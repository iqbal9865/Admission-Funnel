...
const SideBar = () => {
    return (
        <div className=''>
                ...
                <button  className="btn m-3 form-control button" id='sidebar'> <Link className='link' to='/admissionInfo'>  Admission Overview </Link></button> <br/>
                <button  className="btn m-3 form-control button">  <Link className='link' to="/underGraduate">Undergraduate </Link></button> <br/>
                <button  className="btn m-3 form-control button"> <Link className='link' to='/tutionFees'> Tution Fees </Link></button> <br/>
